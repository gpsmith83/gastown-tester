 ...
 */
export function requireRequirementAccess(req: Request, res: Response, next: NextFunction) {
  return async (req: Request, res: Response, next: NextFunction) => {
    try {
      const user = req.user as User;
 ...
 * Expects requirement ID in req.params.requirementId or req.params.id
 */
export function requireRequirementAuthorship(req: Request, res: Response, next: NextFunction) {
  return async (req: Request, res: Response, next: NextFunction) => {
    try {
      const user = req.user as User;
      const requirementId = req.params.requirementId || req.params.id;
 ...
 */
export function preventCrossWorkspaceAccess(req: Request, res: Response, next: NextFunction) {
  return async (req: Request, res: Response, next: NextFunction) => {
    try {
